...
// Si usas React Router DOM v6, la importación del Link podría ser así:
// import { Link } from 'react-router-dom';

// Si usas React Router v5 o similar, la importación es:
...
interface ButtonPerfilProps {
  ...
  Icono: LucideIcon;
  isPrimary?: boolean; // Para diferenciar el botón de "Editar Perfil"
}

const ButtonPerfil: React.FC<ButtonPerfilProps> = ({ link, texto, Icono, isPrimary = false }) => {
  // Clases base para el estilo del botón/enlace
  ...
  const styleClasses = isPrimary
    ...
    : 'text-gray-300 hover:bg-gray-700 hover:text-white px-4 py-2'; // Estilo Secundario (Navegación)

  return (
    // Usamos el componente Link de React Router para manejar la navegación interna
    <Link
      to={link}
      // Aplicamos las clases al Link para que toda el área sea el botón
      ...
      {/* En pantallas pequeñas, mostramos solo la primera palabra o nada, dependiendo del diseño */}
